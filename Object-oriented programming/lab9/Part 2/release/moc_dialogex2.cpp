...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_DialogEx2_t, stringdata0) + ofs), len 
...
const QMetaObject DialogEx2::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_DialogEx2.offsetsAndSize,
